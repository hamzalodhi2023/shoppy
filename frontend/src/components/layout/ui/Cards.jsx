...
function Cards() {
    return (
        <div className="min-h-[400px] w-[250px] sm:min-h-[450px] md:min-h-[500px] lg:min-h-[550px] rounded-2xl p-5 shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] bg-white dark:bg-[#383838] dark:border-[#e97730] dark:border-[1px]">
