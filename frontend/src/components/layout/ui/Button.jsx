...
export const Button2 = ({ text, onclick, size }) => {
    return (
        <button
            onClick={onclick}
            className={`btn ${size === "fit" ? "w-fit" : "w-full"} bg-gradient-to-b from-[#747474] to-[#383838] text-white rounded-md shadow-md border-none hover:shadow-[rgba(56,56,56,0.5)_0_3px_8px] h-10 px-5`}>
            {text}
        </button>
    )
}
